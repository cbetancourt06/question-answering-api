...
using QuestionAnsweringAPI.Models;

namespace QuestionAnsweringAPI.Controllers
{
    [ApiController]
    ...
    public class AnswersController : ControllerBase
    {
        ...
        public AnswersController()
        {
            var options = new DbContextOptionsBuilder<QuestionDbContext>()
               .UseInMemoryDatabase("QuestionAnswering")
               .Options;

            _context = new QuestionDbContext(options);
        }
        ...
        {            
            return _context.Answers != null ?
                        StatusCode(200, await _context.Answers.ToListAsync()) :
        ...
        //public async Task<IActionResult> Create([Bind("Id,Body,QuestionId")] Answer answer)
        //{
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> Edit(int id, [Bind("Id,Body,QuestionId")] Answer answer)
        //{
        //    if (id != answer.Id)
        //    {
        //        return NotFound();
